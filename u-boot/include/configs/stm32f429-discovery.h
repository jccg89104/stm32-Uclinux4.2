...
#define CONFIG_BOOTARGS	"stm32_platform=stm-disco "\
				"console=ttyS0,115200 init=/linuxrc earlyprintk"
/*
...
/*
 * Enable soft spi to drive spi flash
 */
...
#define SPI_INIT f429_soft_spi_init()
...
//#define SPI_DELAY {asm("nop"); asm("nop"); asm("nop"); asm("nop");}//udelay(1)
//#define DEBUG_SPI
